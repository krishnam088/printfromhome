...
// Background message handler (Jab app band ya background mein ho - Firebase)
...
// 6. Web Push Notifications Event (Standard & Stock Availability Alerts)
self.addEventListener('push', (event) => {
    let data = { title: "Print From Home", body: "Aapka product ab stock mein available hai!" };
...
// 7. Notification Click Event (Opens window or focuses existing app client)
