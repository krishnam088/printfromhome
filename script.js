document.addEventListener('DOMContentLoaded', () => {
    ...
    // 🔥 SAFE FALLBACK HELPER FOR ORDER HISTORY UI WITH RE-ORDER BUTTON
    ...
    // 🔥 PAST ORDER RE-ORDER / LOAD TO CART PREVIEW HANDLER
    window.openPastOrderInCartPreview = function(orderId) {
        ...
        if (typeof toggleCartDrawer === 'function') {
            toggleCartDrawer(true); // Open cart drawer for review instead of order status page
        }
