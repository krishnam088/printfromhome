...
// 🔥 ENHANCED USER PRODUCT DETAIL MODAL WITH BULLETPROOF FALLBACK
    window.openProductDetailModal = function(prod) {
        ...
        if (descBox) {
            descBox.textContent = prod.description ? prod.description : "No additional description available for this product.";
        }

        // 🔥 Robust Image Fallback (Handles images array, imageUrl, and old image field)
        let imagesList = [];
