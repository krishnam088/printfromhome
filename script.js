...
   window.updateFloatingCartBar = function() {
        ...
        // 🔥 YEH LINE ADD KARI HAI (Strictly Home Page Check)
        ...
        // 🔥 YEH CONDITION BHI UPDATE KARI HAI (!isHomePage add kiya hai)
        if (!isHomePage || !sessionActiveUser || isAuthVisible || !isStoreActive || totalCount === 0 || (drawerOverlay && drawerOverlay.style.display === 'flex')) {
...
window.renderCartDrawerContents = function() {
    ...
    // 🔥 UPSELLING SECTION (Ab function ke andar properly hai)
